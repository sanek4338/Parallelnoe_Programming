...
```mermaid
xychart-beta
    title "Зависимость времени от числа потоков (ядра = 4)"
    x-axis [1, 2, 4, 8]
    y-axis "Время, сек" 0 --> 90
    line "N=200" [0.094520, 0.095234, 0.094870, 0.111946]
    line "N=400" [0.910782, 0.864745, 0.917968, 0.888135]
    line "N=800" [9.195230, 8.369589, 8.333178, 8.249720]
    line "N=1200" [29.702240, 29.637477, 29.484893, 29.665737]
    line "N=1600" [84.563345, 84.517478, 84.365628, 84.197494]
```
## Анализ графика
...
```mermaid
xychart-beta
    title "Зависимость времени от числа ядер (потоки = 4)"
    x-axis [1, 2, 4, 8]
    y-axis "Время, сек" 0 --> 260
    ...
    line "N=1600" [82.910802, 245.469166, 84.365628, 83.517251]
```
## Анализ графика
...
```mermaid
xychart-beta
    title "Зависимость времени от размера матрицы (потоки = 1)"
